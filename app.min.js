...
async function initWeather() {
    ...
    try {
        const response = await fetch('https://api.openweathermap.org/data/2.5/weather?q=Rochester,NY,US&appid=demo&units=imperial');
        if (response.status === 401) {
            // Demo API key doesn't work, use a fallback
