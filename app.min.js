...
// Check for saved preference first, then system preference, then default to dark
    ...
    function enablePixelFont() {
        ...
        konamiStyle.innerHTML = `
            *, *::before, *::after {
            ...
            /* Font Awesome icons should stay as icons */
            .fa, .fab, .fas, .far, .fal, .fad,
            .fa-brands, .fa-solid, .fa-regular, .fa-light, .fa-duotone,
            [class^="fa-"], [class*=" fa-"] {
...
// Theme Toggle initialization (for pages with hardcoded theme toggle)
